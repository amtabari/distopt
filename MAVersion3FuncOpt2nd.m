function[bestfxnew,bestmxnew,bestxnew,ax,np,e]=MAVersion3FuncOpt2nd(formul,ax,spp,varb,...
...
%@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
%                                FirstFunc
[fxtotal,mxtotal,xtotal,bestmx,bestx,bestfx,e]=feval(@FirstFuncOpt2nd,formul,ax,spp,varb,np,e);
%@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
%@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
%                                MatrixFunc
[bestfx,bestmx,bestx,e]=feval(@MatrixFuncOpt2nd,formul,varb,nc,np,randomno,NOP,N,rp,...
...
tollfirst=10;
counter=0;
% while tollfirst > 0 || tollfirst==0 || counter < 2
while tollfirst > 0 || counter < 5
